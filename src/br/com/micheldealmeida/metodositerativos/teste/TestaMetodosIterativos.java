...
public class TestaMetodosIterativos {
	...
	public static void main(String[] args) {
		...
		int escolha = 0;
		while (escolha != 3) {
			System.out.println("Metodos iterativos para resolucao de sistemas lineares.");
			System.out.println("");
			System.out.println("Por favor, escolha uma das funcoes abaixo de acordo com o numero correspondente:");
			System.out.println("1: Gauss-Seidel");
